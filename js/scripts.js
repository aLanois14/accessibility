...
function cookiesConsent() { 
    // Il n'y a aucun traitement suite au choix de l'utilisateur dans la mesure où il s'agit d'une page d'exemple sans aucun cookie
    ...
    hideCookiesConfirm();
    clearTimeout(hideCookiesConfirm);
}

// Cache le bandeau après 0,1 seconde (sinon il y a conflit de restitution avec le déplacement de focus)
